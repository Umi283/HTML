...
var area = [        
    ...
    function clearCity(){
        while(cit.children.length>1){
            cit.removeChild(cit.children[1]);
        }
    };

    function clearArea(){
        while(are.children.length>1){
            are.removeChild(are.children[1]);
        }
    };
    ...
    for(var i=0;i<provice.length;i++){
        addOption(pro,provice[i].item_name);
    }
    ...
    function getCity(){
        ...
        clearArea();
        for(var i=0;i<provice.length;i++){
            if(provice[i].item_name===pro.value){
                for(var j=0;j<city.length;j++){
                    if(city[j].item_code.substring(0,2)===provice[i].item_code.substring(0,2)){
                        addOption(cit,city[j].item_name);
                    }
                }
                break;
            }
    ...
    function getArea(){
        ...
        for(var i=0;i<city.length;i++){
            if(city[i].item_name===cit.value){
                for(var j=0;j<area.length;j++){
                    if(area[j].item_code.substring(0,4)===city[i].item_code.substring(0,4)){
                        addOption(are,area[j].item_name);
                    }
                }
                break;
            }
